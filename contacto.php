...
<div id="contenedor">
  <div class="container">
    ...
    <form method="POST" action="contacto2.php">
      ...
      <div class="form-group">
        ...
        <textarea id="detalles" name="detalles" placeholder="Por favor, escribe aquí más información sobre tu problema..."></textarea>
      </div>
  ...
  <div id="legal" class="text-center p-3">
    © 2025 Copyright: TecnoGear.com
  </div>
</footer>
